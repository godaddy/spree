...
module Spree
  class Shipment < Spree::Base
    ...
    validates :cost, numericality: { less_than: 999999.99, greater_than_or_equal_to: 0, allow_nil: true }
    validates :adjustment_total, numericality: { less_than: 99999999.99, greater_than: -99999999.99, allow_nil: true }
    ...
    validates :pre_tax_amount, numericality: { less_than: 999999.99, greater_than_or_equal_to: 0, allow_nil: true }
